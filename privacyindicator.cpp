...
bool PrivacyIndicator::load() { return true; }
...
void PrivacyIndicator::setVisible(bool visible) {
  qCDebug(logPrivacy) << "Setting shell plugin visibility - From:" << m_visible
                      << "To:" << visible;
...
bool PrivacyIndicator::checkMicrophoneInUse() { return isAudioInputInUse(); }
