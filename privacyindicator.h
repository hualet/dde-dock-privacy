...
class PrivacyIndicator : public ds::DApplet
{
    ...
    Q_PROPERTY(bool microphoneInUse READ microphoneInUse NOTIFY microphoneInUseChanged)
    Q_PROPERTY(bool locationInUse READ locationInUse NOTIFY locationInUseChanged)
    Q_PROPERTY(bool anyDeviceInUse READ anyDeviceInUse NOTIFY anyDeviceInUseChanged)
...
public:
    ...
    bool microphoneInUse() const { return m_microphoneInUse; }
    bool locationInUse() const { return m_locationInUse; }
    bool anyDeviceInUse() const { return m_cameraInUse || m_microphoneInUse || m_locationInUse; }
